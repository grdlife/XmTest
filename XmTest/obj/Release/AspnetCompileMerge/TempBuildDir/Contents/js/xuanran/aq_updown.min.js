...
function up_down(IsUp) {
    $win = $(window);
    if (IsUp) {
        $win.scrollTop($win.scrollTop() - 1);
        aq_st = setTimeout("up_down(true)", 20);
    }
    else {
        $win.scrollTop($win.scrollTop() + 1);
        aq_st = setTimeout("up_down(false)", 20);
    }
}
